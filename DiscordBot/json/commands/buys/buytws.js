...
module.exports = {
  name: 'buythewintersoldier',
  description: 'buy the winter soldier command',
 async execute(message, args){

    const embed = new Discord.MessageEmbed()
    embed.setTitle('Do you want to buy The Winter Soldier?')
    ...
    embed.setDescription("Click on the 💰 to buy.")
        ...
        buyCollector.on('collect', async (reaction, user) => {
            if (reaction.emoji.name === '💰') {
                message.channel.send("You have just bought The Winter Soldier!")
            } 
        });
    }
}